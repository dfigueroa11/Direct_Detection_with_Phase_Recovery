...
\addplot [thick,data cs = polar, black!60!green, dashed, thick] coordinates {(324,5.5)(144,5.5)};
\addlegendentry[color=black]{symmetry axis}

\coordinate (origin) at (axis cs: 0,0);

\addplot[thick,dashed,data cs=polar, black] coordinates {(0,0)(144,1)} coordinate [at end] (12);
\addplot[thick,dashed,data cs=polar, black] coordinates {(0,0)(72,5)} coordinate [at end] (11);
...
\addplot[thick,dashed,data cs=polar, black] coordinates {(0,0)(144,1)} coordinate [at end] (22);
\addplot[thick,dashed,data cs=polar, black] coordinates {(0,0)(216,5)} coordinate [at end] (21);
