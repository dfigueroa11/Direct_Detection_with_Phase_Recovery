...
\addplot [thick,data cs = polar, black!60!green, dashed, thick] coordinates {(216,5.5)(36,5.5)};
\addlegendentry[color=black]{symmetry axis}

\coordinate (origin) at (axis cs: 0,0);

\addplot[thick,dashed,data cs=polar, black] coordinates {(0,0)(216,5)} coordinate [at end] (12);
\addplot[thick,dashed,data cs=polar, black] coordinates {(0,0)(108,4)} coordinate [at end] (11);
...
\addplot[thick,dashed,data cs=polar, black] coordinates {(0,0)(216,5)} coordinate [at end] (22);
\addplot[thick,dashed,data cs=polar, black] coordinates {(0,0)(-36,4)} coordinate [at end] (21);
