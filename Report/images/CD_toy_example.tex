...
\addplot[blue, domain=-1:0, samples=100, thick] {0.25*(1+cos(deg(pi*x)))};
\addplot[blue, domain=0:1, samples=100, thick] {0.25*(1+cos(deg(pi*x)))+0.25*(1+cos(deg(pi*(x-1))))};
\addplot[blue, domain=1:2, samples=100, thick] {0.25*(1+cos(deg(pi*(x-1))))};
\addplot[only marks, mark=*, mark size=1.5pt, mark options={draw=blue, fill=blue!20}] coordinates{(0,0.5)(1, 0.5)};
