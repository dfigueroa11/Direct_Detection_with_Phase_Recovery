...
\renewcommand{\nomgroup}[1]{%
  \ifnum\pdf@strcmp{#1}{A}=\z@
    \multicolumn{6}{l}{\Large\textbf{Probability theory}}\\\\%
  \else
    \ifnum\pdf@strcmp{#1}{B}=\z@
      \\\\\multicolumn{6}{l}{\Large\textbf{Mathematics}}\\%
  \else
    \ifnum\pdf@strcmp{#1}{C}=\z@
      \\\\\multicolumn{6}{l}{\Large\textbf{Constants}}\\%
  \else
    \ifnum\pdf@strcmp{#1}{D}=\z@
      \\\\\multicolumn{6}{l}{\Large\textbf{Variables}}\\%
  \else
    \ifnum\pdf@strcmp{#1}{E}=\z@
      \\\\\multicolumn{6}{l}{\Large\textbf{Others}}\\%
      \fi
      \fi
      \fi
    \fi
...
% Define how to show the chapter name on the header
